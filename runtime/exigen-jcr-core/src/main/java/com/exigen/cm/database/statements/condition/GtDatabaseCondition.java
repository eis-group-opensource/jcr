...
public class GtDatabaseCondition extends DatabaseCondition {

    private Object value;
    private DatabaseCondition condition;
    protected boolean allowEqual = false; 

    public GtDatabaseCondition(DatabaseCondition condition, Object value) {
        this.value = value;
...
/*
 * $Log: GtDatabaseCondition.java,v $
