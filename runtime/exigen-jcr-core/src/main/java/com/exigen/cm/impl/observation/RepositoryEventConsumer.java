...
class RepositoryEventConsumer {
     ...
     */
    private final RepositoryEventFilter filter;
     ...
     */
    RepositoryEventConsumer(RepositoryImpl repository, EventListener listener, RepositoryEventFilter filter)
...
//                }
        ...
        EventIterator it = new FilteredEventIterator(events, filter, new HashSet(), useOriginalSession, th2, originalSession);
        try {
	        if (it.hasNext()) {
	            listener.onEvent(it);
	        } else {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RepositoryEventConsumer) {
            RepositoryEventConsumer other = (RepositoryEventConsumer) obj;
