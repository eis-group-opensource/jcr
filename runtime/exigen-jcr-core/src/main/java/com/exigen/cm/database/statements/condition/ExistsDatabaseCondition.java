...
public class ExistsDatabaseCondition extends DatabaseCondition {

    private DatabaseSelectAllStatement st;

    public ExistsDatabaseCondition(DatabaseSelectAllStatement st) {
        this.st = st;
    }
...
/*
 * $Log: ExistsDatabaseCondition.java,v $
